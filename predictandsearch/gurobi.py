...
if __name__ == '__main__':
    ...
    # sizes=["CA_750_1100_0.7"]
    sizes=["IS_1500_6"]
    mp.set_start_method('spawn', force=True)
    parser = argparse.ArgumentParser()
    parser.add_argument('--dataDir', type=str, default='/home/cc/code/modeling_strategy/predictandsearch')
    ...
    for size in sizes:
        ...
        SOL_DIR = os.path.join(dataDir,f'dataset/{size}/solution')
        LOG_DIR = os.path.join(dataDir,f'dataset/{size}/logs')
        BG_DIR = os.path.join(dataDir,f'dataset/{size}/BG')
