...
def gen_constr_label(lp_path,cache):
    # 约束sampler
    sample_round = 20
    k = 50
...
def optimize(
    ...
    for lp_file in lp_files:
        ...
        constr_score = gen_constr_label(lp_path,cache)
        ...
        with open(dataset_dir + f"/{lp_file.rsplit('.',1)[0]}" + '.pickle', 'wb') as f:
                pickle.dump([variable_features, constraint_features, edge_indices, edge_features, constr_score], f)
